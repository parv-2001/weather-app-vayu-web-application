...
function getDateTime() {
  ...
  function getPublicIp() {
    fetch("https://api.ipgeolocation.io/ipgeo?apiKey=7ea39259562c490c987b9cddbaa1073f", {
      method: "GET",
      headers: {},
    })
  ...
  function getWeatherData(city, unit, hourlyorWeek) {
    fetch(
      `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=CW7MEDC9AJA3JTZVKRLTJQPN2&contentType=json`,
      {
        method: "GET",
        headers: {},
      }
